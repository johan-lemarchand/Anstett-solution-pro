...
<body>
    ...
    <main>
        ...
        <p>Ce site est destiné à un usage personnel et non commercial. Vous vous engagez à ne pas utiliser ce site d'une manière qui pourrait endommager, désactiver, surcharger ou altérer le site.</p>
...
`,
  ...
  // { title: 'Notre histoire', url: '#', content: '' },
  // { title: 'Projets', url: '#', content: '' },
  // { title: 'Qui sommes-nous', url: '#', content: '' },
  // { title: 'Politique de confidentialité', url: '#', content: '' },
];
