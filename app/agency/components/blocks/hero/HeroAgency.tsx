      ...
      <div className="container pt-17 pb-19 pt-md-18 pb-md-17 text-center">
        <div className="row">
          <div className="col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            ...
            Pour une visibilité renforcée, optez pour nos solutions <br /><span className="underline-3 style-2 yellow">sans complication</span>
            </h1>

            <p className="lead fs-24 text-white lh-sm mb-7 mx-md-13 mx-lg-10" style={slideInDownAnimate("300ms")}>
              Notre but est d'amplifier votre présence sur Internet, et par extension, d'accroître votre audience.
            </p>
          </div>
        </div>
      </div>
