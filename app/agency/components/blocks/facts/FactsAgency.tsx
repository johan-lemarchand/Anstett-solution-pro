      ...
      <div className="container py-15 py-md-17 pb-md-19">
        <div className="row align-items-center gy-8 mb-13">
          <div className="col-lg-7 text-center text-lg-start">
            <h2 className="fs-16 text-uppercase text-muted mb-3">Économisez du temps et de l'argent</h2>
            <h3 className="display-3 mb-0 pe-xl-10 pe-xxl-15">
            Gagnez du temps et économisez de l'argent en choisissant notre équipe <span className="underline-3 style-2 yellow">professionnelle</span>{" "}
            </h3>
          </div>
