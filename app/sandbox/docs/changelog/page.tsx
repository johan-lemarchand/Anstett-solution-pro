          ...
          <div className="card-body">
            <ul className="list-unstyled mb-0">
              <li className="d-flex flex-row mb-2">
                <span className="badge badge-lg bg-pale-purple text-purple rounded me-2 align-self-start">
                  New
                </span>
              ...
              <li className="d-flex flex-row mb-2">
                ...
                <p className="mb-0">
                  Added <mark>VideoPlyr</mark> and <mark>CountUp</mark> reusable
                  components
                </p>
              </li>
            </ul>
            ...
            <ul className="list-unstyled mb-0">
              ...
              <li className="d-flex flex-row mb-2">
                ...
                <p className="mb-0">
                  Added{' '}
                  <Link
                    href="/docs/elements/shapes#snippet-4"
                    className="internal mt-n1"
                  >
                    SVG doodles
                  </Link>
