      ...
      <section id="snippet-1" className="wrapper pt-16">
        <div className="card mb-5">
          <div className="card-body">
            <h2>Core Style</h2>
            <p>
              Core scss file <mark className="doc">'src/assets/scss/style.scss'</mark> is loaded in{" "}
              <mark className="doc">app/layout.tsx</mark>. This <mark className="doc">style.scss</mark> loads bootstrap
              css, default color and font.
            </p>
      ...
      <section id="snippet-2" className="wrapper pt-8">
        <div className="card mb-5">
          <div className="card-body">
            ...
            <p className="mb-2">
              Remove the <mark className="doc">ThemeProvider</mark> and component from{" "}
              <mark className="file">app/layout.tsx</mark>, also delete the <mark className="file">src/theme</mark>{" "}
      ...
      <section id="snippet-3" className="wrapper pt-8 mb-12">
        <div className="card">
          <div className="card-body">
            ...
            <p>
              <strong>Note:</strong> We do not recommend this approach. We used this only for demo purpose{" "}
            </p>

            <h4>Theme Provider</h4>
            <p>
              Few demos has different colors and fonts. We override the defalut color and font on runtime in the
              browser.
            ...
            <p>
              ...
              function of <mark className="folder">/src/theme/themeOptions</mark> injects css files based on current
              route loaded in browser. <mark className="doc">changeColor</mark> function injects 2 css files, one is the
              color CSS path and another is the font CSS path.
            </p>
            ...
            <p>
              <strong className="text-dark">Pros:</strong> Multiple themes can be used besed on route{" "}
            </p>
            <p>
              <strong className="text-dark">Cons:</strong> Theme loads after initializing the page. So user may see
              default theme for very short time when page loads. You may need to use page loader to hide that.
            </p>

            <h4>Sass compilation</h4>
            <p>
              You need to run this command <kbd className="terminal">npm run sass</kbd>. When you successfully run this
              command then all scss converts to CSS inside the <mark className="folder">public/css</mark>
            </p>
