            ...
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    A touchable pure Javascript lightbox with mobile and video
                    support.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    Count up to a targeted number when the number becomes
                    visible.
                  </td>
                </tr>
            ...
            <div className="row gy-6 mb-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/pex1.jpg"
                      srcSet="/img/docs/pex1@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/pex2.jpg"
                      srcSet="/img/docs/pex2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/pex3.jpg"
                      srcSet="/img/docs/pex3@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="row gy-6 mb-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/raw1.jpg"
                      srcSet="/img/docs/raw1@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/raw2.jpg"
                      srcSet="/img/docs/raw2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/raw3.jpg"
                      srcSet="/img/docs/raw3@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="row gy-6 mb-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/un1.jpg"
                      srcSet="/img/docs/un1@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/un2.jpg"
                      srcSet="/img/docs/un2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/un3.jpg"
                      srcSet="/img/docs/un3@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="row gy-6 mb-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/fre1.jpg"
                      srcSet="/img/docs/fre1@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/fre2.jpg"
                      srcSet="/img/docs/fre2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/fre3.jpg"
                      srcSet="/img/docs/fre3@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="row gy-6 mb-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/pix1.jpg"
                      srcSet="/img/docs/pix1@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/pix2.jpg"
                      srcSet="/img/docs/pix2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/pix3.jpg"
                      srcSet="/img/docs/pix3@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="row gy-6 mb-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/ico1.jpg"
                      srcSet="/img/docs/ico1@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/ico2.jpg"
                      srcSet="/img/docs/ico2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/ico3.jpg"
                      srcSet="/img/docs/ico3@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="row gy-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/mo1.jpg"
                      srcSet="/img/docs/mo1@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/mo2.jpg"
                      srcSet="/img/docs/mo2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/mo3.jpg"
                      srcSet="/img/docs/mo3@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/mo4.jpg"
                      srcSet="/img/docs/mo4@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/mo5.jpg"
                      srcSet="/img/docs/mo5@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/mo6.jpg"
                      srcSet="/img/docs/mo6@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/mo7.jpg"
                      srcSet="/img/docs/mo7@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="row gy-6">
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/oth.jpg"
                      srcSet="/img/docs/oth@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="lift rounded">
                  ...
                  >
                    <img
                      src="/img/docs/oth2.jpg"
                      srcSet="/img/docs/oth2@2x.jpg 2x"
                      alt=""
                    />
                  </a>
                </figure>
