...
<div className="shadow-xl p-3 bg-white rounded">Extra larger shadow</div>
`;
      ...
      <section id="snippet-1" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body bg-light rounded-top">
            <div className="shadow-none p-3 bg-gray rounded mb-6">
              No shadow
            </div>
            <div className="shadow-sm p-3 bg-white rounded mb-6">
              Small shadow
            </div>
            <div className="shadow p-3 bg-white rounded mb-6">
              Regular shadow
            </div>
            <div className="shadow-lg p-3 bg-white rounded mb-6">
              Larger shadow
            </div>
            <div className="shadow-xl p-3 bg-white rounded">
              Extra larger shadow
            </div>
          </div>
