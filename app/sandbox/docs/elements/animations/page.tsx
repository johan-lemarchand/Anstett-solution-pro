    ...
    >
      ...
      <section id="snippet-1" className="wrapper pt-16">
        ...
        <p className="lead mb-8">
          Set the <code className="code">data-cue</code> attribute in the target
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <p className="lead mb-8">
          ...
          <code className="code">data-group</code> attribute. With grouping,
          when the first element is triggered, the remaining elements are also
          triggered sequentially, regardless of the scroll amount.
        </p>
        <div className="card">
          <div className="card-body">
