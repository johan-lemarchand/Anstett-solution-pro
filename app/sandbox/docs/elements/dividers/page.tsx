...
import {
  ...
  anglesMarkup,
  wavesMarkup,
} from 'app/sandbox/themes/markups/elements/dividers';
// CUSTOM DATA
const quickAccess = [
        ...
        <div className="card">
          <div className="card-body">
            <figure className="position-relative mb-10">
              <img
                className="img-fluid"
                src="/img/docs/angle-lower-start.jpg"
                alt=""
              />
              <span
            ...
            <figure className="position-relative">
              <img
                className="img-fluid"
                src="/img/docs/angle-lower-end.jpg"
                alt=""
              />
              <span
                className="display-6 text-navy"
            ...
            <figure className="position-relative mb-10">
              <img
                className="img-fluid"
                src="/img/docs/angle-upper-start.jpg"
                alt=""
              />
              <span
                className="display-6 text-navy"
            ...
            <figure className="position-relative mb-10">
              <img
                className="img-fluid"
                src="/img/docs/angle-upper-end.jpg"
                alt=""
              />
              <span
                className="display-6 text-navy"
            ...
            <figure className="position-relative mb-10">
              <img
                className="img-fluid"
                src="/img/docs/angle-upper-end-lower-start.jpg"
                alt=""
              />
              <span
                className="display-6 text-navy"
            ...
            <figure className="position-relative">
              <img
                className="img-fluid"
                src="/img/docs/angle-upper-start-lower-end.jpg"
                alt=""
              />
              <span
                className="display-6 text-navy"
            ...
            <figure className="position-relative">
              <img
                className="img-fluid"
                src="/img/docs/angle-upper-start-lower-start.jpg"
                alt=""
              />
              <span
                className="display-6 text-navy"
            ...
            <figure className="position-relative">
              <img
                className="img-fluid"
                src="/img/docs/angle-upper-end-lower-end.jpg"
                alt=""
              />
              <span
                className="display-6 text-navy"
