  ...
  return (
    ...
    >
          ...
          <div className="card-body">
            ...
            >
              <div className="container py-14 py-md-16">
                <h2 className="display-5 mb-0 text-center text-white">
                  Content goes here
                </h2>
              </div>
            </section>
            ...
            <p className="mt-6">
              ...
              <code className="code">background-size: cover;</code> which scales
              the image as large as possible to fill the container. You can use
              the following classes along with{' '}
              <code className="code">.image-wrapper</code> to change these
              behaviors:
            </p>
            <ul className="list-unstyled mb-6">
              <li>
                <code className="code bg-pale-primary">.bg-auto</code> Disables
                fixed background, changes{' '}
                <mark className="doc">background-size</mark> to{' '}
                <mark className="doc">auto</mark>.
              </li>
              <li>
                <code className="code bg-pale-primary">.bg-full</code> Disables
                fixed background, changes{' '}
                <mark className="doc">background-size</mark> to{' '}
                <mark className="doc">100%</mark>.
              </li>
              <li>
                <code className="code bg-pale-primary">.bg-cover</code> Disables
                fixed background, but keeps{' '}
            ...
            <ul className="list-unstyled mb-0">
              <li>
                <code className="code bg-pale-primary">.bg-overlay</code> Adds
                50% overlay.{' '}
              </li>
              <li>
                <code className="code bg-pale-primary">
        ...
        <div className="card">
          <div className="card-body">
            ...
            <section className="wrapper bg-gradient-primary mb-5">
              <div className="container py-14 py-md-16">
                <h2 className="display-5 mb-0 text-center">
                  Content goes here
                </h2>
              </div>
            </section>
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <p className="lead">Available options:</p>
        <p className="lead mb-8">
          <code className="code">bg-white</code>,{' '}
          <code className="code">bg-primary</code>,{' '}
          <code className="code">bg-aqua</code>,{' '}
          <code className="code">bg-green</code>,{' '}
          <code className="code">bg-leaf</code>,{' '}
          <code className="code">bg-navy</code>,{' '}
          <code className="code">bg-orange</code>,{' '}
          <code className="code">bg-pink</code>,{' '}
          <code className="code">bg-purple</code>,{' '}
          <code className="code">bg-red</code>,{' '}
          <code className="code">bg-violet</code>,{' '}
          <code className="code">bg-yellow</code>,{' '}
          <code className="code">bg-fuchsia</code>,{' '}
          <code className="code">bg-sky</code>,{' '}
      ...
      <section id="snippet-4" className="wrapper pt-16">
        ...
        <p className="lead">Available options:</p>
        <p className="lead mb-8">
          <code className="code">bg-soft-primary</code>,{' '}
          <code className="code">bg-soft-aqua</code>,{' '}
          <code className="code">bg-soft-green</code>,{' '}
          <code className="code">bg-soft-leaf</code>,{' '}
          <code className="code">bg-soft-navy</code>,{' '}
          <code className="code">bg-soft-orange</code>,{' '}
          <code className="code">bg-soft-pink</code>,{' '}
          <code className="code">bg-soft-purple</code>,{' '}
          <code className="code">bg-soft-red</code>,{' '}
          <code className="code">bg-soft-violet</code>,{' '}
          <code className="code">bg-soft-yellow</code>,{' '}
          <code className="code">bg-soft-fuchsia</code>,{' '}
          <code className="code">bg-soft-sky</code>,{' '}
          <code className="code">bg-soft-grape</code>.
        </p>
        <div className="card">
          <div className="card-body">
      ...
      <section id="snippet-5" className="wrapper pt-16">
        ...
        <p className="lead">Available options:</p>
        <p className="lead mb-8">
          <code className="code">bg-pale-primary</code>,{' '}
          <code className="code">bg-pale-aqua</code>,{' '}
          <code className="code">bg-pale-green</code>,{' '}
          <code className="code">bg-pale-leaf</code>,{' '}
          <code className="code">bg-pale-navy</code>,{' '}
          <code className="code">bg-pale-orange</code>,{' '}
          <code className="code">bg-pale-pink</code>,{' '}
          <code className="code">bg-pale-purple</code>,{' '}
          <code className="code">bg-pale-red</code>,{' '}
          <code className="code">bg-pale-violet</code>,{' '}
          <code className="code">bg-pale-yellow</code>,{' '}
          <code className="code">bg-pale-fuchsia</code>,{' '}
          <code className="code">bg-pale-sky</code>,{' '}
          <code className="code">bg-pale-grape</code>.
        </p>
        <div className="card">
          <div className="card-body">
            ...
            <section className="video-wrapper bg-overlay ratio ratio-16x9">
              ...
              <div className="video-content">
                <div className="container text-center">
                  <h2 className="display-5 mb-0 text-white text-center">
                    Content goes here
                  </h2>
                </div>
              </div>
