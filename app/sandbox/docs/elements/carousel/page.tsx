...
import {
  ...
  imageMarkup,
  thumbnailMarkup,
} from 'app/sandbox/themes/markups/elements/carousel';
// CUSTOM DATA
const quickAccess = [
...
export default function Carousel() {
  return (
    <DocLayout
      ...
      description={
        <>
          Here you can find simple carousel examples and usage instructions. For
          further carousel documentation please visit{' '}
          <a
    ...
    >
          ...
          <div className="card-body">
            <SwiperCarousel breakpoints={carouselBreakpoints}>
              {['p1', 'p2', 'p3', 'p4', 'p5'].map(item => (
                <figure
                  className="overlay overlay-1 hover-scale rounded mb-0"
                  key={item}
                >
                  <a href="#">
                    <img
                ...
                <div className="item-inner" key={item}>
                  <article>
                    <div className="card">
                      <div className="card-body">
                        <p>
                          Duis mollis est non commodo luctu, nisi erat porttitor
                          ligula, eget lacinia odio sem nec elit. Nullam quis
                          risus eget urna mollis ornare vel. Nulla vitae elit
                          libero, a pharetra augue. Praesent commodo cursus
            ...
            >
              {[1, 2, 3].map(item => (
                <p key={item}>
                  ...
                  venenatis vestibulum. Aenean eu leo quam. Pellentesque ornare
      ...
      <section id="snippet-4" className="wrapper pt-16">
        ...
        <p className="lead mb-3">
          ...
          <code className="code">.text-*</code> helper class to style and place
          the captions. You can change their placement with the help of flex
          classes as well.
        </p>
        <p className="lead">
          Use{' '}
