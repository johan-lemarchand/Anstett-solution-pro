    ...
    >
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <p className="lead mb-8">
          <code className="code">border-primary</code>,{' '}
          <code className="code">border-aqua</code>,{' '}
          <code className="code">border-green</code>,{' '}
          <code className="code">border-leaf</code>,{' '}
          <code className="code">border-navy</code>,{' '}
          <code className="code">border-orange</code>,{' '}
          <code className="code">border-pink</code>,{' '}
          <code className="code">border-purple</code>,{' '}
          <code className="code">border-red</code>,{' '}
          <code className="code">border-violet</code>,{' '}
          <code className="code">border-yellow</code>,{' '}
          <code className="code">border-fuchsia</code>,{' '}
          <code className="code">border-sky</code>,{' '}
          <code className="code">border-grape</code>,{' '}
          <code className="code">border-soft-primary</code>,{' '}
          <code className="code">border-soft-aqua</code>,{' '}
          <code className="code">border-soft-green</code>,{' '}
          <code className="code">border-soft-leaf</code>,{' '}
          <code className="code">border-soft-navy</code>,{' '}
          <code className="code">border-soft-orange</code>,{' '}
          <code className="code">border-soft-pink</code>,{' '}
          <code className="code">border-soft-purple</code>,{' '}
          <code className="code">border-soft-red</code>,{' '}
          <code className="code">border-soft-violet</code>,{' '}
          <code className="code">border-soft-yellow</code>,{' '}
          <code className="code">border-soft-fuchsia</code>,{' '}
          <code className="code">border-soft-sky</code>,{' '}
          <code className="code">border-soft-grape</code>.
        </p>
