              ...
              <div className="col-lg-8 col-xxl-7 mx-auto position-relative">
                ...
                <div data-cues="slideInDown" data-group="page-title">
                  <h1 className="display-1 fs-64 mb-5 mx-md-10 mx-lg-0">
                    Créez un site web puissant mais facile à utiliser pour{' '}
                    <br />
                    <span className="rotator-fade text-primary">
                      votre entreprise. ,votre portefeuille. ,votre startup. ,le
                      marketing numérique.
                    </span>
                  </h1>

                  <p className="lead fs-24 mb-8">
                    Vous pouvez créer votre site web en quelques minutes grâce
                    aux innombrables fonctionnalités d'Anstett Solutions Pro.
                  </p>
                </div>
          ...
          <div className="container pt-16 pt-mb-18">
            ...
            <div className="demos-wrapper text-center mb-16 mb-md-18">
              ...
              <div className="row mb-10 gx-md-8 gy-12">
                ...
                <div className="col-md-6 col-lg-4 d-none d-md-flex align-items-center justify-content-center flex-column">
                  ...
                  <h3 className="fs-17 text-uppercase text-muted mb-4">
              ...
              <h2
                className="fs-17 text-uppercase text-muted pt-16 mt-n8 mb-6"
                id="prev-demos"
              >
                Démos précédentes
              </h2>
            ...
            <div className="row mb-8 text-center">
              <div className="col-md-11 col-lg-10 col-xl-8 col-xxl-7 mx-auto">
                <h2 className="display-2 mt-3 mb-3 mb-0 px-lg-10 px-xl-0">
                  ...
                  Soltions Pro pour votre site web.
                </h2>
              </div>
            </div>
            ...
            <div className="row gx-lg-0 gy-10 align-items-center mb-16 mb-md-18">
              <div className="col-lg-7 position-relative">
                ...
                <figure className="position-relative" style={{ zIndex: 2 }}>
                  <img
                    src="/img/photos/mi1.png"
                    srcSet="/img/photos/mi1@2x.png 2x"
                    alt=""
                  />
                </figure>
              </div>
              ...
              <div className="col-lg-4 ms-auto">
                <div className="d-flex flex-row mb-6">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Personnalisez facilement les couleurs et les polices, ou
                      choisissez parmi les options fournies.
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex flex-row mb-6">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Équipé de fonctionnalités et d’éléments étonnants pour la
                      conception de pages attrayantes.
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex flex-row">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Créez et maintenez sans effort un portfolio visuellement
                      magnifique et impactant.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row gx-lg-0 gy-10 align-items-center">
              <div className="col-lg-7 position-relative order-lg-2">
                ...
                <figure className="position-relative" style={{ zIndex: 2 }}>
                  <img
                    src="/img/photos/mi2.png"
                    srcSet="/img/photos/mi2@2x.png 2x"
                    alt=""
                  />
                </figure>
              </div>
              ...
              <div className="col-lg-4 me-auto">
                <div className="d-flex flex-row mb-6">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Code pixel-perfect et facilement modifiable avec des
                ...
                <div className="d-flex flex-row mb-6">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Présentez vos produits à vos visiteurs de manière efficace
                ...
                <div className="d-flex flex-row">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Adapte la taille de l’écran pour assurer une compatibilité
            ...
            <div className="row mb-8 text-center mt-17 mt-md-19 mb-9 mb-md-11">
              <div className="col-md-11 col-lg-10 col-xl-8 col-xxl-7 mx-auto">
                <h2 className="display-2 mb-0 px-lg-10 px-xl-0">
                  Construisez votre site web en utilisant les fonctionnalités
                  puissantes d'Anstett Solutions Pro
                </h2>
              </div>
            </div>
          </div>
              ...
              >
                {[1, 2, 3, 4, 5, 6].map(item => (
                  <figure className="rounded-xl shadow-xl" key={item}>
                    <img
                      src={`/img/photos/bp${item}.jpg`}
                      srcSet={`/img/photos/bp${item}@2x.jpg 2x`}
                      alt=""
                    />
                  </figure>
                ))}
          ...
          <div className="container pb-6 pb-md-8">
            ...
            <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                    ...
                    <div className="card shadow-xl rounded-xl">
                      <div className="card-body">
                        <blockquote className="icon mb-0">
                          <p>
                            “Anstett Solutions Pro est vraiment rapide et ça me
                            fait gagner du temps. L’équipe de support est
                            vraiment incroyable.”
                          </p>
                  ...
                  <div className="col-md-6 align-self-end">
                    <div className="card shadow-xl rounded-xl">
                      <div className="card-body">
                        <blockquote className="icon mb-0">
                          <p>
                            “C'est simplement un niveau supérieur en termes de
                            qualité, de documentation et de fonctionnalités. Je
                            doute que vous ayez besoin ou que vous acceptiez un
                            autre modèle à partir de maintenant.”
                          </p>
                          <div className="blockquote-details">
                            <div className="info p-0">
                  ...
                  <div className="col-md-6 col-xl-5 offset-xl-1">
                    <div className="card shadow-xl rounded-xl">
                      <div className="card-body">
                        <blockquote className="icon mb-0">
                          <p>
                            “Cela fait près de 10 ans que j'utilise Themeforest,
                            et j'ai acheté plus de 100 thèmes au fil du temps.
                            Celui-ci est parmi les meilleurs que j'ai trouvés
                            ici.”
                          </p>
                          <div className="blockquote-details">
                            <div className="info p-0">
                  ...
                  <div className="col-md-6 align-self-start">
                    <div className="card shadow-xl rounded-xl">
                      <div className="card-body">
                        <blockquote className="icon mb-0">
                          <p>
                            “Tout simplement les meilleurs templates que j'ai
                            achetés jusqu'à présent. Code extrêmement propre,
                            documentation intuitive, et surtout, un design
                            exceptionnel.”
                          </p>
                          <div className="blockquote-details">
                            <div className="info p-0">
              ...
              <div className="col-lg-4">
                <h2 className="display-2 mb-4 mt-lg-n6">
                  Notre priorité absolue est d’assurer la satisfaction de nos
                  clients.
                </h2>
                <p className="lead fs-22 mb-6">
                  Ne nous croyez pas sur parole. Écoutez les clients parler
                  d'Anstett Solutions Pro.
                </p>
                <a
          ...
          <div className="container pt-16 pt-md-18 text-center position-relative">
            ...
            <div className="row position-relative mb-9 mb-md-11">
              <div className="col-lg-10 col-xl-9 col-xxl-7 mx-auto">
                <div>
                  <img
                    src="/img/demos/icon-grape.png"
                    srcSet="/img/demos/icon-grape@2x.png 2x"
                    alt=""
                  />
                  <h1 className="display-1 fs-64 mt-5 mb-5">
                    Pensez différemment et faites la différence avec Anstett
                    Solutions Pro.
                  </h1>
                  <p className="lead fs-24 mb-8 px-lg-12 px-xl-14 px-xxl-10">
                    Des milliers de clients nous font confiance. Rejoignez-les
                    dès maintenant et créez facilement votre site web
                    exceptionnel en un rien de temps.
                  </p>
                </div>
