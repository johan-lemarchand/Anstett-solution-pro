          ...
          <div className="container pb-14 pb-md-16">
            ...
            <div className="row gx-lg-8 gx-xl-12 gy-6 mb-14 mb-md-19">
              {data.serviceList.map(
                ({ id, icon, title, description, linkUrl }) => (
                  <div className="col-lg-4" key={id}>
                    <div className="d-flex flex-row">
                      <div>
                        <IconBox
                          icon={icon}
                          className="icon btn btn-circle disabled btn-primary me-4"
                        />
                      </div>
            ...
            <div className="row">
              ...
              <p className="lead text-center mb-10 px-md-16 px-lg-0">
                Si vous ne voyez pas de réponse à votre question, vous pouvez
                nous envoyer un e-mail depuis notre formulaire de contact.
              </p>
            ...
            <p className="lead text-center mb-6 px-md-16 px-lg-0">
              La satisfaction client est notre objectif principal. Voir ce que
