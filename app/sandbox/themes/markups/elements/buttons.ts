...
const socialMarkup = `<nav className="nav social">
...
const iconMarkup = `<a className="btn btn-primary btn-icon btn-icon-start rounded me-2">
...
const expandMarkup = `import Link from 'next/link';
...
const playMarkup = `import Link from 'next/link';
