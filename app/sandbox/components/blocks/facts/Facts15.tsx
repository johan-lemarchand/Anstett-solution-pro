  ...
  return (
    <div className="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-11">
      <div className="col-lg-4 text-center text-lg-start">
        ...
        <h3 className="display-3 mb-4 pe-xxl-5">Nous sommes fiers de notre équipe de conception</h3>
        <p className="mb-0 pe-xxl-11">Installez-vous confortablement et détendez-vous pendant que nous nous occupons de vos besoins professionnels.</p>
      </div>
