...
const data = [
  {
    ...
    image: '/img/photos/f1.jpg',
  },
  {
    id: 2,
    url: '#',
    title: 'Destinations',
    subtitle: 'See Destinations',
    image: '/img/photos/f2.jpg',
  },
  {
    id: 3,
    url: '#',
      ...
      <div className="row">
        <div className="col-lg-12 col-xl-10 col-xxl-8 mx-auto text-center">
          <h2 className="display-5 text-center mt-4 mb-10">
            Bonjour! Je suis Caitlyn. Bienvenue sur mon blog. Ici, vous pourrez
            trouver un journal de voyage avec mes conseils.
          </h2>
        </div>
      </div>
