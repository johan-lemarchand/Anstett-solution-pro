          ...
          <div className="row gx-lg-0 gy-10 align-items-center">
            ...
            <div className="col-lg-5 offset-lg-1">
              ...
              <p className="lead fs-lg">
                Je vous propose une expérience photographique unique, mettant en
                valeur vos produits grâce à une maîtrise exceptionnelle de la
                composition et de l'éclairage.
              </p>
              <p>
