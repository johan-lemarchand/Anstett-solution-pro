          ...
          <div className="container">
            <div className="row text-center">
              <div className="col-xl-11 col-xxl-9 mx-auto">
                <h2 className="fs-16 text-uppercase text-gradient gradient-1 mb-3">Rejoindre notre communauté</h2>
            ...
            <div className="d-flex justify-content-center">
              <span>
                <a className="btn btn-lg btn-gradient gradient-1 rounded">Démarrer</a>
              </span>
            </div>
          </div>
        </div>
