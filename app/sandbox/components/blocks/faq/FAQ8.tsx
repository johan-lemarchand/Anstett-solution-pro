  ...
  return (
    <Fragment>
      <div className="position-relative">
        ...
        Si vous ne voyez pas de <span className="text-gradient gradient-7">réponse</span> à votre question, vous pouvez nous envoyer
        un email à partir de notre formulaire de contact.
        </h3>
      </div>
