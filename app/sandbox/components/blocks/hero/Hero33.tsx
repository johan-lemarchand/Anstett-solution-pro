    ...
    <section className="section-frame mx-xxl-11 overflow-hidden">
      ...
      >
        <div className="container py-16 py-md-18 text-center position-relative">
          <div
            className="position-absolute shape yellow d-none d-lg-block w-5"
            style={{ top: '18%', left: '5%' }}
          >
            <img
              src="/img/svg/pie.svg"
          ...
          <div
            className="position-absolute shape leaf d-none d-lg-block w-10"
          ...
          <div
            className="position-absolute shape grape d-none d-lg-block w-6"
          ...
          <div className="row">
            <div className="col-lg-9 col-xxl-8 mx-auto">
              ...
              <p className="lead fs-24 px-md-10 px-lg-0 mx-lg-n10 mx-xl-0 mb-8">
                Je suis très passionné par le travail que je fais et si vous
                êtes curieux vous pouvez trouver mes œuvres sur{' '}
                <a
                  href="#"
                  className="hover"
