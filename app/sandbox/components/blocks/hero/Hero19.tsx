      ...
      <div className="container pt-17 pb-19 pt-md-18 pb-md-17 text-center">
        <div className="row">
          <div className="col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            ...
            >
              Nous apportons des solutions pour vous rendre la vie{' '}
              <span className="underline-3 style-2 yellow">plus facile</span>
            </h1>
            ...
            <div style={slideInDownAnimate('600ms')}>
              <button className="btn btn-white rounded mb-10 mb-xxl-5">
                En savoir plus
              </button>
            </div>
          </div>
