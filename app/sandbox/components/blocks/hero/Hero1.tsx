        ...
        <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          ...
          <div className="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start">
            <h1 className="display-1 mb-5 mx-md-n5 mx-lg-0">
              Développez votre entreprise avec nos solutions.
            </h1>
            <p className="lead fs-lg mb-7">
              Nous aidons nos clients à augmenter le trafic de leur site web,
              leur classement et leur visibilité dans les résultats de
              recherche.
            </p>
