        ...
        <div className="row">
          <div className="col-md-10 col-lg-8 col-xl-8 col-xxl-6 mx-auto mb-13">
            <h1 className="display-1 mb-4" style={slideInDownAnimate('0ms')}>
              Il n’a jamais été aussi facile de garder le contrôle sur vos
              factures
            </h1>
            ...
            >
              Atteignez facilement vos objectifs d’épargne. Ayez toutes vos
              dépenses, revenus récurrents et ponctuels en un seul endroit.
            </p>
