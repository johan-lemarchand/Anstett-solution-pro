        ...
        >
          <div className="card-body p-6 p-md-11 d-lg-flex flex-row align-items-lg-center justify-content-md-between text-center text-lg-start">
            ...
            <NextLink
              ...
              href="#"
              className="btn btn-lg btn-white rounded-xl mb-0 text-nowrap"
            />
          </div>
        </div>
          ...
          <div className="row gy-6 gy-lg-0">
            <div className="col-lg-4">
              <div className="widget">
                ...
                <p className="mb-5">
                  Créons quelque chose de grand ensemble. Nous avons la
                  confiance de plus de 5000 clients. Rejoignez-les en utilisant
                  nos services et développez votre entreprise.
                </p>
                <p className="mb-1">
