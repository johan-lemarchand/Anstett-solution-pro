...
export default function ThumbsCarousel() {
  ...
  const slideImages = [
    {
      id: 1,
      url: '/img/photos/shs1.jpg',
      fullImage: '/img/photos/shs1@2x.jpg',
    },
    {
      id: 2,
      url: '/img/photos/shs2.jpg',
      fullImage: '/img/photos/shs2@2x.jpg',
    },
    {
      id: 3,
      url: '/img/photos/shs3.jpg',
      fullImage: '/img/photos/shs3@2x.jpg',
    },
    {
      id: 4,
      url: '/img/photos/shs4.jpg',
      fullImage: '/img/photos/shs4@2x.jpg',
    },
  ];
