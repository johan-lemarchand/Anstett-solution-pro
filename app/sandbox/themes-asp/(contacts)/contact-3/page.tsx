          ...
          <div className="container pt-18 pt-md-20 pb-21 pb-md-21 text-center">
            <div className="row">
              <div className="col-sm-10 col-md-8 col-lg-6 col-xl-6 col-xxl-5 mx-auto">
                <h1 className="display-1 text-white mb-3">Rester en contact</h1>
                <p className="lead px-xl-10 px-xxl-10">
                  Vous avez des questions? Contactez-nous à partir de notre formulaire de contact et nous vous répondrons sous peu.
                </p>
              </div>
            </div>
          </div>
