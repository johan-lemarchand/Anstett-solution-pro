        ...
        <div className="container py-14 py-md-16">
          ...
          <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            ...
            <div className="col-lg-5">
              <h3 className="display-4 mb-5">Nous rendons vos projets sans stress pour que vous ayez le contrôle parfait.</h3>
        ...
        <div className="container pt-14 pb-18 pt-md-16 pb-md-22 text-center">
          <div className="row">
            <div className="col-lg-10 col-xl-9 col-xxl-8 mx-auto">
              <h2 className="fs-15 text-uppercase text-muted mb-3">Nos prix</h2>
