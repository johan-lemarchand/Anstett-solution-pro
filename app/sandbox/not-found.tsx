          ...
          <div className="container pt-12 pt-md-14 pb-14 pb-md-16">
            <div className="row">
              ...
              <div className="col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center">
                ...
                La page que vous recherchez n’est pas disponible ou a été déplacée. Essayez une autre page ou allez à
                page d’accueil avec le bouton ci-dessous.
                </p>

                <NextLink title="Page d’accueil" href="/" className="btn btn-primary rounded-pill" />
              </div>
            </div>
          </div>
        </section>
